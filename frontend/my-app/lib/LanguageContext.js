...
const translations = {
  en: {
    ...
    categoryName: "Name",
    parentCategory: "Under (parent)",
    topLevel: "Top level",
    noCategories: "No categories yet. Create your first one on the left.",
    addRule: "Add Rule",
  ...
  ar: {
    ...
    setupBudgetDesc: "أضف قواعد التصنيف للبدء في تتبع حدود البنود.",
    spent: "المصروف",
    limit: "الحد",
    left: "متبقي",
    ...
    categoriesTitle: "إدارة البنود",
    manageCategories: "البنود",
    addCategory: "إضافة فئة",
    categoryName: "الاسم",
    parentCategory: "تحت (الأب)",
    topLevel: "المستوى الأعلى",
    noCategories: "لا توجد فئات بعد. أنشئ أول فئة من اليسار.",
    addRule: "إضافة تصنيف",
