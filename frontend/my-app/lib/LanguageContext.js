...
const translations = {
  en: {
    ...
    merchantPlaceholder: "e.g. Uber",
    merchantHint: "Matches if keyword is in SMS",
  ...
  ar: {
    ...
    addRule: "إضافة تصنيف",
    merchantLabel: "كلمة مفتاحية للرسالة",
    merchantPlaceholder: "مثال: Amazon",
    merchantHint: "تتطابق إذا كانت الكلمة موجودة في الرسالة",
